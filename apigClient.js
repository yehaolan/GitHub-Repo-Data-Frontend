...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://bemgtxu9cc.execute-api.us-west-2.amazonaws.com/dev';
    ...
    apigClient.usernameGet = function (params, body, additionalParams) {
        ...
        var result =  apiGatewayClient.makeRequest(usernameGetRequest, authType, additionalParams, config.apiKey);
        return result;
    };
